...
from old_gui.backend.apply_segmentation_model import apply_segmentation
...
class Application(Frame):
    def __init__(self, master=None):
        ...
        words = [
            "Welcome to the Apply Segmentation GUI",
            "!!! Instructions !!!",
    ...
    def pseudo_apply_segmentation(self):
        if apply_segmentation(
            self.input_folder_path, self.output_folder_path, self.npy_file_path
        ):
            npz_lbl = Label(
                self.master,

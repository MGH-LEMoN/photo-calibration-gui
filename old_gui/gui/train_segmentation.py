...
from old_gui.backend.train_segmentation_model import train_segmentation
...
class Application(Frame):
    def __init__(self, master=None):
        ...
        words = [
            "Welcome to the Train Segmentation GUI",
            "!!! Instructions !!!",
            ...
            "4. Click on Train Segmentation and wait until the program quits automatically",
        ]

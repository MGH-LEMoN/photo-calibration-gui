...
fiducials_calibration:
	fspython scripts/func_fiducials_calibration.py \
...
fiducials_correction:
	fspython scripts/func_fiducials_correction.py \
...
2pt_correction:
	fspython scripts/func_retrospective_correction.py \
...
connected_components:
	fspython scripts/func_connected_components.py \
